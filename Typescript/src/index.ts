...
// export function calculate(a:number,b=12,c:number):number{     //giving b defualt value and if making c optional e.g. c?:number,will cause error later inside the function while using it because undefined will be passes in the value of c.so,instead of making it otional, it is better to give a defualt value.             
